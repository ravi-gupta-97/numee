...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      <AuthFormHeading title="Welcome back" subtitle="Please enter your details to sign in." />
      ...
      <div className="flex gap-3 p-4 rounded-lg bg-blue-50 border border-blue-100">
        ...
        <div className="text-sm">
          <span className="font-semibold text-blue-900">Security Update</span>{" "}
          <span className="text-blue-800">
            Two-factor authentication (2FA) is now required for all Super Admin accounts.
          </span>
        </div>
      </div>
      ...
      <form className="space-y-5" onSubmit={handleLogin}>
        ...
        <div className="flex items-center justify-between">
          <CheckboxField
            ...
            label="Remember me"
          />
          <Link href="/user/forgot-password" className="text-sm font-medium text-blue-600 hover:text-blue-700">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className="flex items-center justify-center gap-2 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-700 font-medium hover:bg-gray-50 transition"
        >
